...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Digital Occurrence Book, case management and crime analytics for Kenya Police stations." },
      { property: "og:title", content: "Kenya Police Crime Management System" },
      { property: "og:description", content: "Digital OB, case tracking, and crime hotspot analytics." },
